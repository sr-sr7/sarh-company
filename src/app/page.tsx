...
const PropertyMap = dynamic(() => import('@/components/PropertyMap'), { ssr: false, loading: () => (
  <div style={{ height: 500, background: '#d3e2dc', borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#41646d', fontSize: '1rem' }}>🗺️ جاري تحميل الخريطة...</div>
)})
