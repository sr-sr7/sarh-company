        ...
        {tab==='add' && (can('add_property')||(!!editId&&can('edit_property'))) && (
          <form onSubmit={saveProperty} style={S.form}>
            ...
            <div style={S.formGrid}>
              ...
              <div><label style={S.label}>وحدة السعر</label><select value={form.price_unit} onChange={e=>ff('price_unit',e.target.value)} style={S.select}>{['ريال','ريال / سنة','ريال / شهر','ريال / يوم'].map(u=><option key={u}>{u}</option>)}</select></div>
