...
// ─── Styles ───────────────────────────────────────────────────
const S = {
  page:  { minHeight:'100vh', background:'#d3e2dc', fontFamily:"'Tajawal','Cairo',sans-serif", direction:'rtl' as const },
  ...
  input:{ width:'100%', background:'#d3e2dc', border:'1px solid rgba(39,66,62,0.15)', borderRadius:10, padding:'10px 14px', fontSize:'0.9rem', outline:'none', fontFamily:"'Tajawal','Cairo',sans-serif", boxSizing:'border-box' as const },
  textarea:{ width:'100%', background:'#d3e2dc', border:'1px solid rgba(39,66,62,0.15)', borderRadius:10, padding:'10px 14px', fontSize:'0.9rem', outline:'none', fontFamily:"'Tajawal','Cairo',sans-serif", resize:'vertical' as const, boxSizing:'border-box' as const },
  select:{ width:'100%', background:'#d3e2dc', border:'1px solid rgba(39,66,62,0.15)', borderRadius:10, padding:'10px 14px', fontSize:'0.9rem', outline:'none', fontFamily:"'Tajawal','Cairo',sans-serif", boxSizing:'border-box' as const },
  ...
  uploadZone:{ border:'2px dashed rgba(39,66,62,0.25)', borderRadius:14, padding:24, textAlign:'center' as const, cursor:'pointer', background:'#d3e2dc' },
  ...
  thumbMain:{ position:'absolute' as const, bottom:4, left:4, background:'#41646d', color:'#fff', fontSize:'0.6rem', fontWeight:700, padding:'2px 6px', borderRadius:4 },
      ...
      <div style={S.header}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:12, flexWrap:'wrap' as const }}>
          <span style={{ color:'rgba(30,58,52,0.7)', fontSize:'0.82rem' }}>
            👤 {session.username}
            {session.role === 'admin' && <span style={{ background:'#41646d', color:'#fff', fontSize:'0.65rem', fontWeight:800, padding:'2px 8px', borderRadius:20, marginRight:6 }}>مالك</span>}
          </span>
          {can('maintenance') && (
        ...
        {tab==='properties' && (
          ...
          <div style={{ marginBottom:16, position:'relative' }}>
            ...
            <input
              ...
              style={{ width:'100%', padding:'11px 40px 11px 14px', borderRadius:12, border:'1.5px solid rgba(39,66,62,0.18)', fontSize:'0.9rem', fontFamily:"'Tajawal','Cairo',sans-serif", outline:'none', background:'#d3e2dc', boxSizing:'border-box' as const, direction:'rtl' }}
            />
          </div>
            ...
            <div style={S.formGrid}>
              ...
              {form.operation === 'على السوم' ? (
                <div style={{ gridColumn:'1 / -1' }}>
                  ...
                  <p style={{ fontSize:'0.75rem', color:'#41646d', margin:'8px 0 0' }}>
                ...
                <div style={{ gridColumn:'1 / -1' }}>
                  ...
                  {form.price_unit === 'آخر سوم' && (
                    <p style={{ fontSize:'0.75rem', color:'#41646d', marginTop:6, margin:'6px 0 0' }}>
              ...
              <div style={S.fullCol}>
                ...
                />
                {form.video_url && (
                  <div style={{marginTop:8, fontSize:'0.75rem', color:'#41646d', display:'flex', alignItems:'center', gap:6}}>
                    ...
                    : adminUsers.map(u=>(
                      <tr key={u.id}>
                        ...
                        <td style={{...S.td,fontSize:'0.75rem',color:'#526266',maxWidth:300}}>
                          {u.role==='admin' ? <span style={{color:'#41646d',fontWeight:700}}>جميع الصلاحيات</span>
                  ...
                  {editingUser.role==='user' && (
                    <div style={{marginBottom:24}}>
                      ...
                      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))',gap:10}}>
                        {PERMS.map(([key,label])=>(
                          <label key={key} style={{display:'flex',alignItems:'center',gap:10,padding:'10px 14px',borderRadius:10,border:`1px solid ${editingUser.permissions?.[key]?'#27423e':'rgba(39,66,62,0.15)'}`,background:editingUser.permissions?.[key]?'rgba(39,66,62,0.06)':'#d3e2dc',cursor:'pointer',transition:'all 0.2s'}}>
              ...
              <form onSubmit={addUser}>
                ...
                {newUser.role==='user' && (
                  <div style={{marginBottom:20}}>
                    ...
                    <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))',gap:10}}>
                      {PERMS.map(([key,label])=>(
                        <label key={key} style={{display:'flex',alignItems:'center',gap:10,padding:'10px 14px',borderRadius:10,border:`1px solid ${newUser.permissions[key]?'#27423e':'rgba(39,66,62,0.15)'}`,background:newUser.permissions[key]?'rgba(39,66,62,0.06)':'#d3e2dc',cursor:'pointer',transition:'all 0.2s'}}>
