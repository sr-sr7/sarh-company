...
const PropertyMap = dynamic(() => import('@/components/PropertyMap'), {
  ssr: false,
  loading: () => (
    <div style={{ height:500, background:'#f4ede4', display:'flex', alignItems:'center', justifyContent:'center', borderRadius:16 }}>
  ...
  return (
    <main style={{ fontFamily:"'Tajawal','Cairo',sans-serif", direction:'rtl', minHeight:'100vh', background:'#f4ede4' }}>
      ...
      <div style={{ maxWidth:1400, margin:'0 auto', padding:'24px 24px 60px' }}>
        {loading ? (
          <div style={{ height:560, background:'#f4ede4', borderRadius:16, display:'flex', alignItems:'center', justifyContent:'center' }}>
              ...
              {properties.map(p => (
                ...
                >
                  {p.main_image
                    ...
                    : <div style={{ width:52, height:52, background:'#f4ede4', borderRadius:8, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1.5rem', flexShrink:0 }}>🏠</div>
                  }
