    ...
    <div style={{
      ...
      <div style={{ display:'flex', alignItems:'center', gap:10 }}>
        ...
        <div style={{ display:'flex', gap:6 }}>
          {ids.map((id, i) => (
            <span key={id} style={{ background:'rgba(65,100,109,0.25)', border:'1px solid rgba(65,100,109,0.4)', borderRadius:8, padding:'4px 12px', fontSize:'0.78rem', color:'#41646d', fontFamily:'monospace', fontWeight:700 }}>
              عقار {i + 1}
            </span>
          ))}
        </div>
      ...
      <div style={{ display:'flex', gap:10 }}>
        {ids.length === 2 && (
          <a
            ...
            style={{ background:'#41646d', color:'#1e3a34', borderRadius:10, padding:'10px 24px', fontWeight:800, textDecoration:'none', fontSize:'0.9rem', whiteSpace:'nowrap' }}>
            قارن الآن ←
          </a>
        )}
        <button
