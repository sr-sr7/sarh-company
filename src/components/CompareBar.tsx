...
export default function CompareBar() {
  ...
  return (
    <div style={{
      ...
      color:'#f4ede4', padding:'14px 24px',
      ...
      <div style={{ display:'flex', gap:10 }}>
        ...
        <button
          onClick={clear}
          style={{ background:'rgba(255,255,255,0.1)', border:'1px solid rgba(255,255,255,0.2)', color:'#f4ede4', borderRadius:10, padding:'10px 16px', fontWeight:700, cursor:'pointer', fontFamily:"'Tajawal','Cairo',sans-serif", fontSize:'0.85rem' }}>
          إلغاء ✕
        </button>
      </div>
    </div>
